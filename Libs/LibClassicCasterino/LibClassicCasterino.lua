...
f.NAME_PLATE_UNIT_ADDED = Passthrough
f.NAME_PLATE_UNIT_REMOVED = Passthrough
...
--     -- if DMW.Tables.Misc then
--         local Pointer = DMW.Tables.Misc.guid2pointerF(unitGUID)
--         DMW.Tables.Misc.pointer2unit[Pointer] = unit
--         DMW.Tables.Misc.unit2pointer[unit] = Pointer
...
--     local Pointer = DMW.Tables.Misc.guid2pointerF(unitGUID)
--     DMW.Tables.Misc.pointer2unit[Pointer] = nil
--     DMW.Tables.Misc.unit2pointer[unit] = nil
